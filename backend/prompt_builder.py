...
def build_prompt(target_agent: str, project_root: Path | None, chat_md_path: Path,
    ...
    clauses.append(
        ...
        "without @. "
        "NEVER use @agent in a question to the user (e.g. \"Want @deepseek "
        "to do X?\" or \"Should @codex check this?\"); that dispatches the "
        "agent before the user can answer. Write \"Want deepseek to do X?\" "
        "instead — the user will @summon if they agree.\n"
